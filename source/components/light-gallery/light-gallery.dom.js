...
(function () {
    "use strict";
    window.lightGallery = function (container, options) {
        var defaults = {
            mode: 'slide',
            useCSS: true,
        ...
        //    elg = '[data-group="' + $(container).data().group + '"]'
        //    el = $(container +e lg),
        el = $(container),
        plugin = this,
        $children = null,
                ...
                el.each(function () {
                    ...
                    $children.on('click', function (e) {
                        if( settings.selector !== null ) {
                            ...
                            if ( settings.group == true && dataGroup ) {
                                $children = $('[data-group="' + dataGroup + '"]');
                            } else {
                                $children = $(this);
                            }
                        }
                        e.preventDefault();
                        e.stopPropagation();
                        index = $children.indexOf(this, $children);
                        prevIndex = index;
                        setUp.init(index);
                    });
                });
        ...
        var setUp = {
                ...
                if(settings.caption === true){
                    ...
                    for(i=0;i < $children.length; i++){
                        ...
                        if(title != undefined && title != ""){
                            $slide.eq(i).append('<div class="lg-title">'+title+'</div>');
                        }
                    }
                }
            },
            ...
            buildThumbnail: function () {
                if (settings.thumbnail === true && $children.length > 1) {
                    ...
                    $('<a class="cl-thumb"></a>').insertAfter($prev);
